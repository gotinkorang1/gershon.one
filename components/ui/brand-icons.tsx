...
/**
 * Inline brand marks for GitHub and LinkedIn.
 *
 * lucide-react removed its deprecated brand icons in the 1.x line, so importing
 * `Github` / `Linkedin` from lucide breaks the build on any newer version. These
 * self-contained SVGs mirror lucide's prop API (className, aria-*, etc. spread
 * onto the <svg>) so they drop in as replacements and never depend on the icon
 * library's version.
 */
